        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/khayran.png" className="w-10 rounded-md" />
              <q>Ignore it, or own it.</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Khayran Ald Afasy" disabled={false} speed={3} className="custom-class" />
            </h1>
            <BlurText
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a href="./assets/Khayran Ald Afasy.pdf" download="Khayran Ald Afasy.pdf" className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors">
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Khayran Ald Afasy"
              title="Web Developer"
              handle="_khyranxald"
              status="Online"
              contactText="Contact Me"
              avatarUrl="./assets/khayran1.png"
              showUserInfo={true}
              enableTilt={true}
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.50<span className="text-violet-500">/4.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>

                <ShinyText text="Working with heart, creating with mind." disabled={false} speed={3} className="text-sm md:text-base text-violet-400" />
              </div>
            </div>
        ...
        <div className="tools mt-32">
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {listTools.map((tool) => (
              ...
              >
                <img src={tool.gambar} alt="Tools Image" className="w-16 h-16 object-contain bg-zinc-800 p-2 rounded-lg group-hover:bg-zinc-900 transition-all duration-300" />
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form action="https://formsubmit.co/rehanxald@gmail.com" method="POST" className="bg-zinc-800 p-10 w-full rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
